...
public class UserDaoImpl {
	...
	public int insertUser(User user) {
		return DBUtil.executeUpdate("insert into user (sex,QQ,password,phonenum,nickname,imageurl,companyid) values (?,?,?,?,?,?,?)", new Object[] { user.getSex(),user.getQQ(),user.getPassword(),user.getPhonenum(),user.getNickname(),user.getUserid()+".jpg",user.getCompanyid()});
	}
