        ...
        btnChange.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!user.getPassword().equals(password.getText().toString())){
                    ...
                    Toast.makeText(ChangePasswordActivity.this, "您修改后的密码不一致！", Toast.LENGTH_SHORT).show();
                }else if (!isContainAll(confirmPassword.getText().toString())){
                    Toast.makeText(ChangePasswordActivity.this, "密码中必须包含数字、英文（大或小写）！", Toast.LENGTH_SHORT).show();
                }else if (newPassword.getText().toString().length()>12 || newPassword.getText().toString().length()<6){
                    Toast.makeText(ChangePasswordActivity.this, "密码必须为6-12位", Toast.LENGTH_SHORT).show();
                }else{
