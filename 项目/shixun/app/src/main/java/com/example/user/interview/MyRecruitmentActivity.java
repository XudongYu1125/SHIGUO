...
public class MyRecruitmentActivity extends AppCompatActivity {
    ...
    private List<Position> recruitmentList = new ArrayList<>();
    ...
    private void requestData() {
        ...
        Request request = new Request.Builder().url(Constant.BASE_IP + Constant.URL_MY_POSITON).post(body).build();
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                recruitmentList.addAll((List<Position>) new Gson().fromJson(list,type));
    ...
    private void findViews() {
        ...
        adapter = new MyRecruitmentAdapter(recruitmentList, R.layout.my_recruitment_item, MyRecruitmentActivity.this);
