...
public class TabHostActivity extends AppCompatActivity {
    ...
    private String[] tabStr = {"题型", "招聘", "消息"};
    private Class[] fragementArr = {TestActivity.class, InterviewActivity.class, MessageActivity.class};
    //一般状态的显示图标
    private int[] imageArr = {R.drawable.tabhost_test_normal, R.drawable.tabhost_view_normal, R.drawable.tabhost_msg_normal};
    //选中状态的显示图标
    private int[] imgArr = {R.drawable.tabhost_test_selected, R.drawable.tabhost_view_selected, R.drawable.tabhost_msg_selscted};
...
// list
    ...
    private void more(View view) {
        ...
        it1.setClass(TabHostActivity.this, ChatRecordActivity.class);
        startActivity(it1);
    }
}
