...
/**
 * Servlet implementation class UserSearchById
 */
@WebServlet("/User/SearchById")
public class UserSearchByIdServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(!resStr.equals("")) {
			Gson gson = new Gson();
			String user = gson.toJson(new UserServiceImpl().searchUserById(Integer.parseInt(resStr)));
