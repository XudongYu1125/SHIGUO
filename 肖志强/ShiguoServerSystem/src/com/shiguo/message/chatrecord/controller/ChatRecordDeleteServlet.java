 ...
 */
@WebServlet("/ChatRecord/Delete")
public class ChatRecordDeleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ChatRecordDeleteServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("Delete ChatRecord");
		...
		if(new ChatRecordServiceImpl().dropChatRecord(chatRecord.getChatrecordid())) {
