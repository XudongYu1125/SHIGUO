                        ...
                        if (event == SMSSDK.EVENT_GET_VERIFICATION_CODE) {
                            ...
                            if (result == SMSSDK.RESULT_COMPLETE) {
                                ...
                                if (name.getText().toString().equals("") || password.getText().toString().equals("")) {
                                    ...
                                    registerTask.execute(Constant.URL_LOCAL+"Add");
                                }
                            } else {
                                // TODO 处理错误的结果
    ...
    public class RegisterTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            switch (userStatus.getStatus()) {
                ...
                //手机号已注册
                case "2":
                    Toast.makeText(RegisterActivity.this, "该手机号码已注册！", Toast.LENGTH_SHORT).show();
                    break;
                //昵称已存在
                case "1":
                    Toast.makeText(RegisterActivity.this, "该昵称已存在！", Toast.LENGTH_SHORT).show();
                    break;
                //注册失败
                case "3":
