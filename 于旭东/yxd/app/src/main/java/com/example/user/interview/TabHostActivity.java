...
public class TabHostActivity extends AppCompatActivity {
    ...
    private Class[] fragementArr = {TestFragment.class,InterviewActivity.class,MessageActivity.class, PersonalActivity.class};
    //一般状态的显示图标
    ...
    private   void setCurImage(String tabId){
        for(int i = 0;i<tabStr.length;++i){
            ...
            if(tabId == tabStr[i]){
                ...
                imageView.setImageResource( imageArr[i] );
                textView.setTextColor(getResources().getColor(R.color.fontSelected));
            }
        }
    }
    @Override
